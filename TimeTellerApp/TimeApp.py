...
def printNumbers():
    global listOf9Numbers, Tries, startTime, modifiedList
    Tries += 1
    endTime = time.time()
...
def findAllOutcomes():
    global distanceBetweenCellsX, distanceBetweenCellsY
    # make a grid?
...
def insertText():
    global firstTime, distanceBetweenCellsY, distanceBetweenCellsX
    for v in range(3):
        for h in range(3):
            ...
            if v == 1 and h == 1:
                print("center fixed")
                canvas.create_text(xText, yText + 40, text=f"{Y} Years, {m} Months, {d} Days, and {H} Hours", font=("Arial", 12))
            else:
                canvas.create_text(xText, yText, text=f"{Y} Years, {m} Months, {d} Days, and {H} Hours", font=("Arial", 8))
        
    canvas.create_text(150, 200, text=f"{modifiedList[1]}%", font=("Arial", 35))
    canvas.create_text(400, 200, text=f"{modifiedList[2]}%", font=("Arial", 35))
    canvas.create_text(655, 200, text=f"{modifiedList[3]}%", font=("Arial", 35))
    canvas.create_text(150, 450, text=f"{modifiedList[4]}%", font=("Arial", 35))

    canvas.create_text(400, 450, text=f"{modifiedList[0]}%", font=("Arial", 45))
    
    canvas.create_text(655, 450, text=f"{modifiedList[5]}%", font=("Arial", 35))
    canvas.create_text(150, 700, text=f"{modifiedList[6]}%", font=("Arial", 35))
    canvas.create_text(400, 700, text=f"{modifiedList[7]}%", font=("Arial", 35))
    canvas.create_text(655, 700, text=f"{modifiedList[8]}%", font=("Arial", 35))
