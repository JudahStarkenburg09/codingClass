...
def wordGuessing():
    ...
    guessRoot = tk.Tk()
    guessRoot.title("Word Guessing Game")

    # Create a frame for the letters
    letters_frame = tk.Frame(guessRoot)
    ...
    for letter in letters:
        ...
        guessRoot.bind(letter, key_press)  # Bind letter keys to key_press function

    # Create labels for the word and remaining lives
    word_label = tk.Label(guessRoot, text="", font=("Arial", 18))
    word_label.pack(pady=10)
    lives_label = tk.Label(guessRoot, text="", font=("Arial", 14))
